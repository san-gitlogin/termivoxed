...
1. **Create Project** → Enter project name and video path
2. **Add Segments** → Define voice-over sections with timing
...
**Made with ❤️ by Santhosh T with assistance from Claude**
